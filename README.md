...
- Automation & CI/CD
  ...
  - Bash scripts (scripts/) for: - Infrastructure provisioning - EC2 configuration - React build & deploy - Terraform output export
...
- Reads:
  ...
  - cloudfront_domain_name
    ...
    from Terraform outputs (envs/dev).
